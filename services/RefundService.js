const { refundMethodUrl, merchantCode, applicationName, applicationPassword, referenceNumberPrefix } = require('../Consts');
...
/**
 * Calls refund method from Paycell Web SDK
 * 
...
module.exports.refund = function (req, res) {
  ...
  var response = request.post(refundMethodUrl, { json: data },
